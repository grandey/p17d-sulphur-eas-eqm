...
# file: amwg_diag_b_eas0_vs_b_2000.csh
# History: Benjamin S. Grandey, 2017-08
#   Based on p17c_mam7_2000_vs_p17c_mam3_2000.csh by Daniel Rothenberg
# Use: Running interactively on Geyser (via Yellowstone):
#   execgy
#   module load ncl
#   module load nco
#   ./amwg_diag_b_eas0_vs_b_2000.csh
...
# set test_casename  = b40.20th.track1.2deg.001
set test_casename = p17d_b_eas0
set test_filetype = monthly_history 
#set test_filetype = time_series

set test_path_history =  /glade/scratch/bgrandey/archive/$test_casename/atm/hist/
set test_path_climo   =  /glade/scratch/bgrandey/amwg_climo/$test_casename/
set test_path_diag    =  /glade/scratch/bgrandey/amwg_diag/$test_casename/
...
set cntl_casename   =  p17d_b_2000
set cntl_filetype = monthly_history 
#set cntl_filetype = time_series

set cntl_path_history =  /glade/scratch/bgrandey/archive/$cntl_casename/atm/hist/
set cntl_path_climo   =  /glade/scratch/bgrandey/amwg_climo/$test_casename/
...
set test_first_yr = 41           # first year (must be >= 1)
set test_nyrs     = 60           # number of yrs (must be >= 1)

# FOR CNTL == USER ONLY (otherwise skip this section)
# First year of data is: $cntl_first_yr     (must be >= 1)
# Number of years is: $cntl_nyrs         (must be >= 1)

set cntl_first_yr = 41        # first year (must be >= 1)
set cntl_nyrs     = 60        # number of yrs (must be >= 1)
...
set email_address = benjamin@smart.mit.edu
...
# ARCTIC (60N-90N)
  set western_alaska      = 0  # (0=ON,1=OFF) 
  set whitehorse_canada   = 0  # (0=ON,1=OFF)
  set resolute_canada     = 0  # (0=ON,1=OFF)
  set thule_greenland     = 0  # (0=ON,1=OFF)
# NORTHERN MIDLATITUDES (23N-60N)
  set new_dehli_india     = 0  # (0=ON,1=OFF)
  set kagoshima_japan     = 0  # (0=ON,1=OFF)
  set tokyo_japan         = 0  # (0=ON,1=OFF)
  set midway_island       = 0  # (0=ON,1=OFF)
  set shipP_gulf_alaska   = 0  # (0=ON,1=OFF)
  set san_francisco_ca    = 0  # (0=ON,1=OFF)
  set denver_colorado     = 0  # (0=ON,1=OFF)
  set great_plains_usa    = 0  # (0=ON,1=OFF)
  set oklahoma_city_ok    = 0  # (0=ON,1=OFF)
  set miami_florida       = 0  # (0=ON,1=OFF)
  set new_york_usa        = 0  # (0=ON,1=OFF)
  set w_north_atlantic    = 0  # (0=ON,1=OFF)
  set shipC_n_atlantic    = 0  # (0=ON,1=OFF)
  set azores              = 0  # (0=ON,1=OFF)
  set gibraltor           = 0  # (0=ON,1=OFF)
  set london_england      = 0  # (0=ON,1=OFF)
  set western_europe      = 0  # (0=ON,1=OFF)
  set crete               = 0  # (0=ON,1=OFF)
# TROPICS (23N-23S0
  set central_india       = 0  # (0=ON,1=OFF)
  set madras_india        = 0  # (0=ON,1=OFF)
  set diego_garcia        = 0  # (0=ON,1=OFF)
  set cocos_islands       = 0  # (0=ON,1=OFF)
  set christmas_island    = 0  # (0=ON,1=OFF)
  set singapore           = 0  # (0=ON,1=OFF)
  set danang_vietnam      = 0  # (0=ON,1=OFF)
  set manila              = 0  # (0=ON,1=OFF)
  set darwin_australia    = 0  # (0=ON,1=OFF)
  set yap_island          = 0  # (0=ON,1=OFF)
  set port_moresby        = 0  # (0=ON,1=OFF)
  set truk_island         = 0  # (0=ON,1=OFF)
  set raoui_island        = 0  # (0=ON,1=OFF)
  set gilbert_islands     = 0  # (0=ON,1=OFF)
  set marshall_islands    = 0  # (0=ON,1=OFF)
  set samoa               = 0  # (0=ON,1=OFF)
  set hawaii              = 0  # (0=ON,1=OFF)
  set panama              = 0  # (0=ON,1=OFF)
  set mexico_city         = 0  # (0=ON,1=OFF)
  set lima_peru           = 0  # (0=ON,1=OFF)
  set san_juan_pr         = 0  # (0=ON,1=OFF)
  set recife_brazil       = 0  # (0=ON,1=OFF)
  set ascension_island    = 0  # (0=ON,1=OFF)
  set ethiopia            = 0  # (0=ON,1=OFF)
  set nairobi_kenya       = 0  # (0=ON,1=OFF)
# SOUTHERN MIDLATITUDES (23S-60S)
  set heard_island        = 0  # (0=ON,1=OFF)
  set w_desert_australia  = 0  # (0=ON,1=OFF)
  set sydney_australia    = 0  # (0=ON,1=OFF)
  set christchurch_nz     = 0  # (0=ON,1=OFF)
  set easter_island       = 0  # (0=ON,1=OFF)
  set san_paulo_brazil    = 0  # (0=ON,1=OFF)
  set falkland_islands    = 0  # (0=ON,1=OFF)
# ANTARCTIC (60S-90S)
